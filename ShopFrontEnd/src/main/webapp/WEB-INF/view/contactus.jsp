...
<style>
body{
	background: url('file:///D:/eclipse_workspaace/ShopFrontend/src/main/images/map.jpg') fixed;
  ...
  <body>
    <section id="contact">
       ...
       <div class="card border-0">
           ...
           <h1 class="text-center text-uppercase" style="color:#00091a"><b>contact us</b></h1>
         </div>
       </div>
